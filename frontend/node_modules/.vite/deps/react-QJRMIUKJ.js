...
var _loadRequested, _hasLoaded, _isInit, _isWaiting, _closeToEnded, _paused, _currentTime, _duration, _seeking, _config, _SpotifyAudioElement_instances, upgradeProperty_fn;
var SpotifyAudioElement = class extends (globalThis.HTMLElement ?? class {
}) {
  constructor() {
    super();
    __privateAdd(this, _SpotifyAudioElement_instances);
    ...
    __privateMethod(this, _SpotifyAudioElement_instances, upgradeProperty_fn).call(this, "config");
  }
  async load() {
    var _a, _b, _c;
...
_config = new WeakMap();
_SpotifyAudioElement_instances = new WeakSet();
...
spotify-audio-element/dist/react.js:
  ...
  *)
*/
//# sourceMappingURL=react-QJRMIUKJ.js.map
