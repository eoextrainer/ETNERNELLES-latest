...
var _loadRequested, _hasLoaded, _readyState, _seeking, _seekComplete, _error, _config, _textTracksVideo, _initialVolume, _YoutubeVideoElement_instances, upgradeProperty_fn;
var YoutubeVideoElement = class extends (globalThis.HTMLElement ?? class {
  ...
  constructor() {
    ...
    __privateAdd(this, _textTracksVideo, null);
    __privateAdd(this, _initialVolume, 1);
  ...
  async load() {
    ...
    __privateSet(this, _textTracksVideo, document.createElement("video"));
    this.textTracks = __privateGet(this, _textTracksVideo).textTracks;
    ...
    this.api = new YT.Player(iframe, {
      events: {
        onReady: () => {
          ...
          if (__privateGet(this, _initialVolume) !== 1) {
            (_a = this.api) == null ? void 0 : _a.setVolume(__privateGet(this, _initialVolume) * 100);
          }
      ...
      if (state === YT.PlayerState.PLAYING || state === YT.PlayerState.BUFFERING) {
        ...
        captionList.forEach((t) => {
          if (![...this.textTracks].some((tt) => tt.language === t.languageCode)) {
            __privateGet(this, _textTracksVideo).addTextTrack("subtitles", t.displayName, t.languageCode);
          }
          this.textTracks = __privateGet(this, _textTracksVideo).textTracks;
        });
        this.dispatchEvent(new Event("loadstart"));
    ...
    this.api.addEventListener("onVolumeChange", () => {
      ...
      __privateSet(this, _initialVolume, apiVolume);
      this.dispatchEvent(new Event("volumechange"));
    });
  ...
  */
  ...
  set volume(val) {
    ...
    __privateSet(this, _initialVolume, val);
    this.loadComplete.then(() => {
      var _a;
  ...
  get volume() {
    var _a;
    if (!this.isLoaded) {
      return __privateGet(this, _initialVolume);
    }
...
_error = new WeakMap();
_config = new WeakMap();
_textTracksVideo = new WeakMap();
_initialVolume = new WeakMap();
...
youtube-video-element/dist/react.js:
  ...
  *)
*/
//# sourceMappingURL=react-HHKBU2XR.js.map
