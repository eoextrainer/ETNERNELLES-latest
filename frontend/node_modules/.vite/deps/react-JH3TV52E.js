...
var _loadRequested, _hasLoaded, _iframe, _playerState, _currentTime, _muted, _volume, _paused, _seeking, _readyState, _config, _onMessage, _TwitchVideoElement_instances, sendCommand_fn, upgradeProperty_fn;
var TwitchVideoElement = class extends (globalThis.HTMLElement ?? class {
}) {
  constructor() {
    super();
    __privateAdd(this, _TwitchVideoElement_instances);
    ...
    __privateAdd(this, _onMessage, async (event) => {
      var _a, _b, _c, _d;
      if (!__privateGet(this, _iframe).contentWindow) return;
      ...
      if (data.namespace === "twitch-embed") {
        ...
        if (oldVolume !== __privateGet(this, _playerState).volume || oldMuted !== __privateGet(this, _playerState).muted) {
          if (__privateGet(this, _playerState).volume !== void 0) {
            __privateSet(this, _volume, __privateGet(this, _playerState).volume);
          }
          if (__privateGet(this, _playerState).muted !== void 0) {
            __privateSet(this, _muted, __privateGet(this, _playerState).muted);
          }
    ...
    __privateMethod(this, _TwitchVideoElement_instances, upgradeProperty_fn).call(this, "config");
  }
  get config() {
  ...
  get paused() {
    if (!__privateGet(this, _playerState).playback) return __privateGet(this, _paused);
    return __privateGet(this, _playerState).playback === PlaybackState.IDLE;
  }
  get ended() {
    if (!__privateGet(this, _playerState).playback) return false;
  ...
  get currentTime() {
    if (!__privateGet(this, _playerState).currentTime) return __privateGet(this, _currentTime);
    return __privateGet(this, _playerState).currentTime;
  }
  set currentTime(val) {
    __privateSet(this, _currentTime, val);
    this.loadComplete.then(() => {
      __privateMethod(this, _TwitchVideoElement_instances, sendCommand_fn).call(this, PlayerCommands.SEEK, val);
    });
  }
  get defaultMuted() {
  ...
  set muted(val) {
    ...
    this.loadComplete.then(() => {
      __privateMethod(this, _TwitchVideoElement_instances, sendCommand_fn).call(this, PlayerCommands.SET_MUTED, val);
    });
  }
  get volume() {
  ...
  set volume(val) {
    ...
    this.loadComplete.then(() => {
      __privateMethod(this, _TwitchVideoElement_instances, sendCommand_fn).call(this, PlayerCommands.SET_VOLUME, val);
    });
  }
  get playsInline() {
  ...
  play() {
    ...
    __privateMethod(this, _TwitchVideoElement_instances, sendCommand_fn).call(this, PlayerCommands.PLAY);
  }
  pause() {
    __privateSet(this, _paused, true);
    __privateMethod(this, _TwitchVideoElement_instances, sendCommand_fn).call(this, PlayerCommands.PAUSE);
  }
};
...
_TwitchVideoElement_instances = new WeakSet();
...
twitch-video-element/dist/react.js:
  ...
  *)
*/
//# sourceMappingURL=react-JH3TV52E.js.map
